...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className="home__title"> Salendar Singh
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm a MERN Stack Web Developer based in India, with a strong passion for building full-stack applications and delivering great user experiences. I'm also skilled in Data Structures and Algorithms using Java, which helps me write efficient and scalable code. As a fresher, I am highly dedicated to learning, building, and growing as a developer.</p>
